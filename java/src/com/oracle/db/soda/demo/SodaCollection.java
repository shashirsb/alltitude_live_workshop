package com.oracle.db.soda.demo;
...
public class SodaCollection {
	...
	public static void main(String[] args) {
		...
		try {
		System.out.println("Lets connect to oracle db json");
		db = dbConnect();
		// dbConnectSimple();	
		if(args[0].equals("col")) {
			if(args[1].equals("create")) {
				db.admin().createCollection(args[3]);
				System.out.println("\n Collection " +args[3]+ "created successfully!!!"+ "\n");
			}
			if(args[1].equals("drop")) {
				col = db.openCollection(args[3]);
				col.admin().drop();
				System.out.println("\n Collection " +args[3]+ "dropped successfully!!!"+ "\n");
			}
	...
	public static OracleDatabase dbConnect() {
	...
	public static OracleDatabase dbConnectSimple() {
